        ...
        <div className="mt-5 pt-4 border-t border-graphite/5 flex flex-col gap-3">
          ...
          <motion.div layout className="flex gap-2 w-full">
            ...
            <motion.button 
              ...
              className="flex-1 py-3 bg-terracotta hover:bg-terracotta-dark text-white font-medium text-[10px] uppercase tracking-wider transition-all duration-300 rounded shadow-md shadow-terracotta/10 flex items-center justify-center gap-2"
            >
            ...
            {/* Add to Bag button fluidly slides/expands in on card hover */}
            <AnimatePresence>
              {isHovered && (
                <motion.button 
                  layout
                  ...
                  className="px-4 py-3 bg-graphite hover:bg-terracotta text-white rounded flex items-center justify-center gap-2 overflow-hidden whitespace-nowrap"
